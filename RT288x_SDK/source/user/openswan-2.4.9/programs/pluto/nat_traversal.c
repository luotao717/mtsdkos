 ...
 * for more details.
 *
 * RCSID $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.4.9/programs/pluto/nat_traversal.c#1 $
 */
...
static void _natd_hash(const struct hash_desc *hasher, char *hash,
	...
	const ip_address *ip, u_int16_t port /* network order */)
{
	union hash_ctx ctx;
 ...
 *
 *
 * $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.4.9/programs/pluto/nat_traversal.c#1 $
 *
 */
