 ...
 *
 * $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/testing/utils/ike-scan/utils.c#1 $
 *
 * Author: Roy Hills
 * Date: 5 April 2004
 *
...
static char rcsid[] = "$Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/testing/utils/ike-scan/utils.c#1 $";	/* RCS ID for ident(1) */
