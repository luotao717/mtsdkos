 ...
 *
 * RCSID $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/packaging/fedora/config-ppc-smp.h#1 $
 */
#define	_CONFIG_RH_PPC_SMP_H_	/* seen it, no need to see it again */
