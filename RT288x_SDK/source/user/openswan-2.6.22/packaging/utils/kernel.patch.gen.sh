#!/bin/bash
#
# RCSID $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/packaging/utils/kernel.patch.gen.sh#1 $
...
echo found $i
echo "RCSID \$Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/packaging/utils/kernel.patch.gen.sh#1 $" >$patchdir/$l
