 ...
 *
 * RCSID $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/user/openswan-2.6.22/packaging/mandrake/config-i386-smp.h#1 $
 */
#define	_CONFIG_MD_I386_SMP_H_	/* seen it, no need to see it again */
